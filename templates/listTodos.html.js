        ...
        <div class="col-12">
            <div class="row">
                <div class="col-12 col-md-6 col-lg-4 d-flex flex-nowrap justify-content-center align-items-center bg-dark p-1 listTodo_b1">
                    ...
                    <h4 class="p-2 listTodo_b1_Date" style="color:${stateCheckBox.color};">${new Date(todo.createdAt).toLocaleString()}</h4>
                </div>
            </div>
            <div class="row">
                <div class="col-12 d-flex flex-nowrap justify-content-between align-items-center p-2 listTodo_b2">
                    <a href="#"><h4 class="listTodo_b2_title" data-id="${todo.id}">${todo.title}</h4></a>
